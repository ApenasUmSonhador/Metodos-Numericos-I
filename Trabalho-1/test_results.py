...
def tabela_comparativa(C, Q0, Q1, tol, max_iter):
    ...
    print("-" * 75)
    print(f"Ponto Fixo         {root_fp:<15.6f}{error_fp:<15.2e}{time_fp:<15.6f}{iter_fp:>7}")
    print(f"Newton Modificado  {root_nm:<15.6f}{error_nm:<15.2e}{time_nm:<15.6f}{iter_nm:>7}")
    print(f"Secante            {root_sec:<15.6f}{error_sec:<15.2e}{time_sec:<15.6f}{iter_sec:>7}")
